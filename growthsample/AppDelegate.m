...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[GrowthPush sharedInstance] initializeWithApplicationId:GBApplicationId credentialId:GBCredentilaId environment:kGrowthPushEnvironment];
    ...
    [[Growthbeat sharedInstance] setIntentHandlers:intentHandlers];
